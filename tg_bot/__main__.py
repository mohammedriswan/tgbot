...
MESSI_IMG = "https://telegra.ph/file/65b361087ba375be7c771.jpg"


PM_START_TEXT = """

ഹായ് {}!!
ഞാൻ ഒരു ഗ്രൂപ്പ് മാനേജർ ബോട്ട് ആണ്. പക്ഷെ വെറുതെ സമയം കളയണ്ട എന്നെ സിനിമ ടി.വി ഗ്രൂപ്പിൽ മാത്രമേ ഉപയോഗിക്കാൻ കഴിയൂ..
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(MESSI_IMG,PM_START_TEXT.format(escape_markdown(first_name), escape_markdown(bot.first_name), OWNER_ID),
